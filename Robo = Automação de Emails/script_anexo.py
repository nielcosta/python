...
fromaddr = "danielmendes.dsr@gmail.com"
toaddr = "vaniaom@gmail.com, daniel.acheiaqui@gmail.com"
...
anexo = open(r'E:\Python\Robos Python\Secao92\panfleto.pdf',"rb")
...
s.login(fromaddr, 'nleafbxtzdrezdrl')
